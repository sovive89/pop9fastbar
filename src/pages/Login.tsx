  ...
  return <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        animationDelay: '0.2s'
          ...
          <Button variant="social" size="full" onClick={handleLogin} className="group">
          ...
          <div className="flex gap-4 justify-center">
            <Button variant="glass" size="icon" onClick={handleLogin} className="w-14 h-14 rounded-xl hover:border-primary/50">
        ...
        {/* Terms */}
        <p className="text-center text-sm text-muted-foreground mt-12 max-w-xs animate-fade-in" style={{
        animationDelay: '0.4s'
      }}>
